...
Pod::Spec.new do |s|
  ...
  s.subspec 'MaplyComponent' do |mc|
    ...
    mc.public_header_files = 'ios/library/WhirlyGlobe-MaplyComponent/include/*.h', "WhirlyGlobeSrc/WhirlyGlobe-MaplyComponent/include/vector_tiles/*.h", # "WhirlyGlobeSrc/WhirlyGlobe-MaplyComponent/include/private/*.h"
