...
#    l.dependency 'shapelib'
  ...
  s.subspec 'MaplyComponent-Headers' do |mch|
    mch.source_files = 'WhirlyGlobeSrc/WhirlyGlobe-MaplyComponent/include/*.h', 'WhirlyGlobeSrc/WhirlyGlobe-MaplyComponent/include/private/*.h'
    mch.private_header_files = 'WhirlyGlobeSrc/WhirlyGlobe-MaplyComponent/private/*.h'
