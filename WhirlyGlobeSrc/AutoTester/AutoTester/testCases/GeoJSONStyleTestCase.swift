...
class GeoJSONStyleTestCase: MaplyTestCase {
    ...
    func setupCommon(baseVC: MaplyBaseViewController) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
            ...
            self.landUseSource = GeoJSONSource.init(viewC: self.baseViewController, geoJSONURL: Bundle.main.url(forResource: "belfast_ireland_landusages", withExtension: "geojson"), sldURL: Bundle.main.url(forResource: "osm_landuse", withExtension: "sld"))
            self.landUseSource?.startParse(completion: {
                
                self.switchLandUse?.isOn = true
                self.switchLandUse?.isEnabled = true
                
                self.waterAreaSource = GeoJSONSource.init(viewC: self.baseViewController, geoJSONURL: Bundle.main.url(forResource: "belfast_ireland_waterareas", withExtension: "geojson"), sldURL: Bundle.main.url(forResource: "osm_water", withExtension: "sld"))
                self.waterAreaSource?.startParse(completion: {
                    
                    self.waterLineSource = GeoJSONSource.init(viewC: self.baseViewController, geoJSONURL: Bundle.main.url(forResource: "belfast_ireland_waterways", withExtension: "geojson"), sldURL: Bundle.main.url(forResource: "water_lines", withExtension: "sld"))
                    self.waterLineSource?.startParse(completion: {
                        
                        self.switchWater?.isOn = true
                        self.switchWater?.isEnabled = true
                        
                        self.buildingsSource = GeoJSONSource.init(viewC: self.baseViewController, geoJSONURL: Bundle.main.url(forResource: "belfast_ireland_buildings", withExtension: "geojson"), sldURL: Bundle.main.url(forResource: "osm_buildings", withExtension: "sld"))
                        self.buildingsSource?.startParse(completion: {
                            
                            self.switchBuildings?.isOn = true
                            self.switchBuildings?.isEnabled = true
                            
                            self.roadsSource = GeoJSONSource.init(viewC: self.baseViewController, geoJSONURL: Bundle.main.url(forResource: "belfast_ireland_roads", withExtension: "geojson"), sldURL: Bundle.main.url(forResource: "osm_roads", withExtension: "sld"))
    ...
    override func setUpWithGlobe(_ globeVC: WhirlyGlobeViewController) {
        ...
        globeVC.animate(toPosition: MaplyCoordinateMakeWithDegrees(-5.93, 54.597), height: 0.5, heading: 0.0, time: 0.5)
    }
    ...
    override func setUpWithMap(_ mapVC: MaplyViewController) {
        ...
        mapVC.animate(toPosition:MaplyCoordinateMakeWithDegrees(-5.93, 54.597), height: 0.5, time: 1.0)
