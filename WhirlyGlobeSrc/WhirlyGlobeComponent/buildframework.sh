...
popd
xcodebuild -target WhirlyGlobeComponent -configuration Debug -sdk iphonesimulator
xcodebuild -target WhirlyGlobeComponent -configuration Release -sdk iphonesimulator
xcodebuild -target WhirlyGlobeComponent -configuration Debug -sdk iphoneos
xcodebuild -target WhirlyGlobeComponent -configuration Release -sdk iphoneos

# name and build location
PROJECT_NAME=WhirlyGlobeComponent
FRAMEWORK_NAME=WhirlyGlobeComponent
...
# lipo -create build/Debug-iphoneos/libWhirlyGlobeComponent.a build/Debug-iphonesimulator/libWhirlyGlobeComponent.a -output "$FRAMEWORK_DIR/Versions/Current/$FRAMEWORK_NAME"
lipo -create build/Release-iphoneos/libWhirlyGlobeComponent.a build/Release-iphonesimulator/libWhirlyGlobeComponent.a -output "$FRAMEWORK_DIR/Versions/Current/lib${FRAMEWORK_NAME}.a"
...
mv $FRAMEWORK_DIR WhirlyGlobeComponent.framework
