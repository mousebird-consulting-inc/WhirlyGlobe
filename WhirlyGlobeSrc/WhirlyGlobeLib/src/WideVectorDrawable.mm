...
"   vertPos /= vertPos.w;\n"
"   vec3 theDir = a_dir;\n"
"   float dirLen = length(theDir);\n"
"   if (u_pixDispSize * dirLen * u_lineWidth > a_maxlen  && a_maxlen > 0.0)\n"
"   {\n"
"      float mostLen = a_maxlen / (u_pixDispSize * u_lineWidth);\n"
"      theDir *= mostLen/dirLen;\n"
"   }\n"
"   vec2 screenDir = (u_mvpMatrix * vec4(theDir,0.0)).xy;\n"
