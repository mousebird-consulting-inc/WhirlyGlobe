...
void WhirlyKitShapeInfo::setColor(WhirlyKit::RGBAColor _color)
{
    color = _color;
}

RGBAColor WhirlyKitShapeInfo::getColor()
{
    return color;
}

void WhirlyKitShapeInfo::setLineWidth(float _lineWidth)
{
    lineWidth = _lineWidth;
}

float WhirlyKitShapeInfo::getLineWidth()
{
    return lineWidth;
}

void WhirlyKitShapeInfo::setShapeId(WhirlyKit::SimpleIdentity _shapeId)
{
    shapeId = _shapeId;
}

SimpleIdentity WhirlyKitShapeInfo::getShapeId()
{
    return shapeId;
}

void WhirlyKitShapeInfo::setInsideOut(bool _insideOut)
{
    insideOut = _insideOut;
}

bool WhirlyKitShapeInfo::getInsideOut()
{
    return insideOut;
}

void WhirlyKitShapeInfo::setZBufferRead(bool _zBufferRead)
{
    zBufferRead = _zBufferRead;
}

bool WhirlyKitShapeInfo::getZBufferRead()
{
    return zBufferRead;
}

void WhirlyKitShapeInfo::setZBufferWrite(bool _zBufferWrite)
{
    zBufferWrite = _zBufferWrite;
}

bool WhirlyKitShapeInfo::getZBufferWrite(){
    return zBufferWrite;
}

void WhirlyKitShapeInfo::setHasCenter(bool _hasCenter)
{
    hasCenter = _hasCenter;
}

bool WhirlyKitShapeInfo::getHasCenter()
{
    return hasCenter;
}

void WhirlyKitShapeInfo::setCenter(Point3d _center)
{
    center = _center;
}

Point3d WhirlyKitShapeInfo::getCenter()
{
    return center;
}
