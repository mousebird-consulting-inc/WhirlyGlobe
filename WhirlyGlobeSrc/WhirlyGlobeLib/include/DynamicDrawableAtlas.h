...
public:
    ...
    bool addDrawable(BasicDrawable *draw,ChangeSet &changes,bool enabled=true,SimpleIdentity destTexId=EmptyIdentity,bool *addedBigDrawable=NULL,const Point3d *center=NULL,double drawSize=0.0);
