...
public:
    ...
    bool addTexture(Texture *,Point2f *realSize,SubTexture &subTex,OpenGLMemManager *memManager,std::vector<ChangeRequest *> &changes,int borderPixels,int bufferPixels=0);
