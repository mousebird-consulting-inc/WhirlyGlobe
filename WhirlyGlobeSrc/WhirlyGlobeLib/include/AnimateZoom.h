...
/** Animate Zoom is WhirlyGlobe Animation Delegate
    that will animate zoom over
    time.
 */
@interface AnimateZoom : NSObject<WhirlyGlobeAnimationDelegate>
...
@property (nonatomic) float startZoomHeightAboveGlobe;
/// Where to end the zoom.
@property (nonatomic) float endZoomHeightAboveGlobe;
