...
public:
     ...
     */
    bool pointOnSphereFromScreen(CGPoint pt,const Eigen::Matrix4d *transform,const WhirlyKit::Point2f &frameSize,WhirlyKit::Point3d *hit,bool normalized);

    /** From a world location (3D), figure out the projection to the screen
        Returns a point within the frame
      */
    CGPoint pointOnScreenFromSphere(const WhirlyKit::Point3d &worldLoc,const Eigen::Matrix4d *transform,const WhirlyKit::Point2f &frameSize);
