...
JNIEXPORT void JNICALL Java_com_mousebirdconsulting_maply_Point3d_nativeInit
...
{
	Point3dClassInfo *classInfo = Point3dClassInfo::getClassInfo(env,"com/mousebirdconsulting/maply/Point3d");
