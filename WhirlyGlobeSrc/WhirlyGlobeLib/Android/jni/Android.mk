...
LOCAL_C_INCLUDES += $(INCLUDE_DIR)/core/
LOCAL_C_INCLUDES += $(THIRD_PARTY)/eigen/
LOCAL_C_INCLUDES += $(THIRD_PARTY)/boost/
LOCAL_C_INCLUDES += $(THIRD_PARTY)/proj-4/src/
LOCAL_C_INCLUDES += $(THIRD_PARTY)/clipper/
LOCAL_C_INCLUDES += $(THIRD_PARTY)/shapelib/
LOCAL_C_INCLUDES += $(THIRD_PARTY)/libjson/
LOCAL_C_INCLUDES += $(THIRD_PARTY)/glues/include/
LOCAL_C_INCLUDES += $(THIRD_PARTY)/glues/source/
LOCAL_C_INCLUDES += $(THIRD_PARTY)/glues/source/include/
...
MAPLY_CORE_SRC_FILES := BigDrawable.cpp CoordSystem.cpp Cullable.cpp DefaultShaderPrograms.cpp Dictionary.cpp \
					...
					PerformanceTimer.cpp QuadDisplayController.cpp Quadtree.cpp RawData.cpp \
...
MAPLY_JNI_FILES := Maply_jni.cpp AttrDictionary_jni.cpp ChangeSet_jni.cpp CoordSystemDisplayAdapter_jni.cpp MaplyRenderer_jni.cpp MapScene_jni.cpp \
					MapView_jni.cpp \
					...
					InternalMarker_jni.cpp MarkerInfo_jni.cpp MarkerManager_jni.cpp Texture_jni.cpp QuadPagingLayer_jni.cpp QuadImageTileLayer_jni.cpp \
