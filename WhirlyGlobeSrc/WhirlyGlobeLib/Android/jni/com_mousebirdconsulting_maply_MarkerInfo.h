...
#include <jni.h>
/* Header for class com_mousebirdconsulting_maply_MarkerInfo */

#ifndef _Included_com_mousebirdconsulting_maply_MarkerInfo
#define _Included_com_mousebirdconsulting_maply_MarkerInfo
#ifdef __cplusplus
extern "C" {
#endif
/*
