...
public class CullTree {
    ...
    public CullTree(CoordSystemDisplayAdapter coordSystem, Mbr localMbr, int depth, int maxDrawPerNode){
        ...
        initialise(coordSystem,localMbr,depth,maxDrawPerNode);
    }
    ...
    native void initialise(CoordSystemDisplayAdapter coordSystem, Mbr localMbr, int depth, int maxDrawPerNode);
    static
    {
        nativeInit();
    }
