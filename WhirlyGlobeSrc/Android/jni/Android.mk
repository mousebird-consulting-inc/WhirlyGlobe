...
MAPLY_JNI_FILES := Maply_jni.cpp AttrDictionary_jni.cpp BaseInfo_jni.cpp ChangeSet_jni.cpp CoordSystemDisplayAdapter_jni.cpp \
					...
					Scene_jni.cpp View_jni.cpp MapViewState_jni.cpp GlobeScene_jni.cpp GlobeView_jni.cpp GlobeViewState_jni.cpp FakeGeocentricDisplayAdapter_jni.cpp SingleVertexAttributeInfo_jni.cpp ParticleBatch_jni.cpp ParticleSystem_jni.cpp ParticleSystemManager_jni.cpp \
