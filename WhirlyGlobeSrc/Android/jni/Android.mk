...
MAPLY_CORE_SRC_FILES := BaseInfo.cpp BasicDrawable.cpp BasicDrawableInstance.cpp BigDrawable.cpp CoordSystem.cpp Cullable.cpp DefaultShaderPrograms.cpp Dictionary.cpp \
					...
					SelectionManager.cpp ShapeReader.cpp SphericalEarthChunkManager.cpp SphericalMercator.cpp Tesselator.cpp Texture.cpp TextureAtlas.cpp TileQuadLoader.cpp \
...
MAPLY_JNI_FILES := Maply_jni.cpp AttrDictionary_jni.cpp ChangeSet_jni.cpp CoordSystemDisplayAdapter_jni.cpp \
					...
					GeoCoordSystem_jni.cpp Quaternion_jni.cpp AngleAxis_jni.cpp Point4d_jni.cpp Sticker_jni.cpp StickerInfo_jni.cpp StickerManager_jni.cpp
