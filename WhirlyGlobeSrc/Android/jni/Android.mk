...
MAPLY_JNI_FILES := Maply_jni.cpp AttrDictionary_jni.cpp BaseInfo_jni.cpp ChangeSet_jni.cpp CoordSystemDisplayAdapter_jni.cpp \
					FontTextureManagerAndroid.cpp GeneralDisplayAdapter_jni.cpp Identifiable_jni.cpp LabelInfoAndroid.cpp LabelInfo_jni.cpp LabelManager_jni.cpp LayoutManager_jni.cpp \
					...
					GeoCoordSystem_jni.cpp Quaternion_jni.cpp AngleAxis_jni.cpp Point4d_jni.cpp  Sticker_jni.cpp StickerInfo_jni.cpp StickerManager_jni.cpp QuadImageOfflineLayer_jni.cpp Proj4CoordSystem_jni.cpp QuadTracker_jni.cpp QuadTrackerPointReturn_jni.cpp
