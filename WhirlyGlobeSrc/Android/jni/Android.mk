...
AAPLUS_SRC_FILES = AAAberration.cpp AAAngularSeparation.cpp AABinaryStar.cpp AACoordinateTransformation.cpp AADate.cpp AADiameters.cpp \
				AADynamicalTime.cpp AAEarth.cpp AAEaster.cpp AAEclipses.cpp AAEclipticalElements.cpp AAElementsPlanetaryOrbit.cpp \
				AAElliptical.cpp AAEquationOfTime.cpp AAEquinoxesAndSolstices.cpp AAFK5.cpp AAGalileanMoons.cpp AAGlobe.cpp \
				AAIlluminatedFraction.cpp AAInterpolate.cpp AAJewishCalendar.cpp AAJupiter.cpp AAKepler.cpp AAMars.cpp AAMercury.cpp \
				AAMoon.cpp AAMoonIlluminatedFraction.cpp AAMoonMaxDeclinations.cpp AAMoonNodes.cpp AAMoonPerigeeApogee.cpp AAMoonPhases.cpp \
				AAMoslemCalendar.cpp AANearParabolic.cpp AANeptune.cpp AANodes.cpp AANutation.cpp AAParabolic.cpp AAParallactic.cpp \
				AAParallax.cpp AAPhysicalJupiter.cpp AAPhysicalMars.cpp AAPhysicalMoon.cpp AAPhysicalSun.cpp AAPlanetPerihelionAphelion.cpp \
				AAPlanetaryPhenomena.cpp AAPluto.cpp AAPrecession.cpp AARefraction.cpp AARiseTransitSet.cpp AASaturn.cpp AASaturnMoons.cpp \
				AASaturnRings.cpp AASidereal.cpp AAStellarMagnitudes.cpp AASun.cpp AAUranus.cpp AAVenus.cpp
AAPLUS_SRC_DIR := $(AAPLUS_DIR)
LOCAL_SRC_FILES += $(AAPLUS_SRC_FILES:%=$(AAPLUS_SRC_DIR)/%)
...
MAPLY_JNI_FILES := Maply_jni.cpp AttrDictionary_jni.cpp AngleAxis_jni.cpp Affine2d_jni.cpp \
					...
					SelectionManager_jni.cpp Shader_jni.cpp SingleLabelAndroid.cpp SphericalMercatorCoordSystem_jni.cpp Scene_jni.cpp Sticker_jni.cpp StickerInfo_jni.cpp StickerManager_jni.cpp Sun_jni.cpp ShapeInfo_jni.cpp Shape_jni.cpp ShapeSphere_jni.cpp ShapeManager_jni.cpp \
					Texture_jni.cpp \
