...
MAPLY_JNI_FILES := Maply_jni.cpp AttrDictionary_jni.cpp BaseInfo_jni.cpp ChangeSet_jni.cpp CoordSystemDisplayAdapter_jni.cpp \
					...
					GeoCoordSystem_jni.cpp Quaternion_jni.cpp AngleAxis_jni.cpp Point4d_jni.cpp  Sticker_jni.cpp StickerInfo_jni.cpp StickerManager_jni.cpp QuadImageOfflineLayer_jni.cpp Proj4CoordSystem_jni.cpp
