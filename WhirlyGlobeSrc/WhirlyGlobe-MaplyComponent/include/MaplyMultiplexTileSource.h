...
/** This tile source combines a bunch of individual tile sources
    for animation.
  */
@interface MaplyMultiplexTileSource : NSObject<MaplyTileSource>

/// Initialize with the various tile sources you want to use
- (id)initWithSources:(NSArray *)tileSources;

/// Coordinate system they'd better all share
