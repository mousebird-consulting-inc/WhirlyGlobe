            ...
            "features": [
{
   ...
   "geometry":{
      ...
      "coordinates":[
        ...
        val clippedVecObj = vecObj.clipToGrid(Point2d(10.0 / 180.0 * PI, 10.0 / 180.0 * PI))
        ...
        return control.addVector(tessVecObj, vecInfo, RenderControllerInterface.ThreadMode.ThreadAny)
    }
