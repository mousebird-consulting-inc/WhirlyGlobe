...
class SimpleStyleTestCase(activity: Activity) : MaplyTestCase(activity, "Simple Vector Styles") {
    ...
    companion object {
        ...
        private fun marker(
            title: String, lat: Double, lon: Double, m: String? = null, bg: String? = null,
            ...
            lSz: Double? = null, lx: Double? = null, ly: Double? = null
        ): String {
            return """
        {
          "type": "Feature",
                                    ...
                                    arrayOf("f0f", "#0f0").flatMap { mColor ->
                                        arrayOf("0fa", "#a0f").flatMap { fColor ->
                                            arrayOf("fa0", "#0af").map { sColor ->
                                                lon += lonStep
                                                if ((n++ % rowSize) == 0) {
                                                    lat -= latStep; lon = startLon
                                                }
                                                marker(
                                                    "", lat, lon, m, bg, circle, mColor, null, fColor,
        ...
        private fun markers2(): String {
            return arrayOf(-4.0, -1.5, 0.0, 1.0).flatMap { ox ->
                arrayOf(-5.0, -1.5, 0.0, 1.0).map { oy ->
                    marker(
                        "${fmt(ox)},${fmt(oy)}", -30.0, 140.0, null, "marker-stroked",
        ...
        private fun markers3(): String {
            return arrayOf(
                marker(
                    "", -33.0, 140.0, "square", "wide", false, "#f00", 0.7, "#00f", null,
                    null, null, null, "large", null, null, null, null, null, null
                ),
                marker(
                    "", -33.1, 140.0, "square", "tall", false, "#00f", 0.7, "#00f", null,
                    null, null, null, "large", null, null, null, null, null, null
                ),
                marker(
                    "", -33.0, 140.1, "wide", "square", false, "#0f0", 0.7, "#00f", null,
                    null, null, null, "large", null, null, null, null, null, null
                ),
                marker(
                    "", -33.1, 140.1, "tall", "square", false, "#f0f", 0.7, "#00f", null,
                    null, null, null, "large", null, null, null, null, null, null
                )
            ).joinToString(",")
        }
