...
JNIEXPORT jboolean JNICALL Java_com_mousebird_maply_QuadImageTileLayer_allFramesLoaded
(JNIEnv *env, jobject obj)
{
    try
    {
    ...
    {
        __android_log_print(ANDROID_LOG_VERBOSE, "Maply", "Crash in QuadImageTileLayer::allFramesLoaded()");
    }
