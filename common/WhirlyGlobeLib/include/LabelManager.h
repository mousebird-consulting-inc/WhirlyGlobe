...
public:
    ...
    SimpleIdentity addLabels(PlatformThreadInfo *threadInfo,const std::vector<SingleLabel *> &labels,const LabelInfo &desc,ChangeSet &changes);
    SimpleIdentity addLabels(PlatformThreadInfo *threadInfo,const std::vector<SingleLabelRef> &labels,const LabelInfo &desc,ChangeSet &changes);
    ...
    void removeLabels(PlatformThreadInfo *threadInfo,const SimpleIDSet &labelID,ChangeSet &changes);
