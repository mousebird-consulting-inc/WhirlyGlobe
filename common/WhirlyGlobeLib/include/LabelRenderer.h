...
typedef enum {WhirlyKitLabelBaseline,WhirlyKitLabelVCenter, /*...*/} LabelVerticalAlign;
...
public:
    ...
    LabelInfo(const LabelInfo &that) = default;
    ...
    LabelVerticalAlign labelVAlign = WhirlyKitLabelBaseline;
    ...
    /// Indicates that this label will be drawn over a marker generated by the same feature.
    bool mergedSymbol = false;
