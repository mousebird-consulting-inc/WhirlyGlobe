...
public:
    ...
    ImportantNodeSet calcCoverageImportance(const std::vector<double> &minImportance,int maxNodes,bool siblingNodes,std::vector<double> &maxRejectedImport);
    ...
    /** Calculate the set of nodes to load based on importance.
      ...
      */
    std::tuple<int,ImportantNodeSet> calcCoverageVisible(const std::vector<double> &minImportance,int maxNodes,const std::vector<int> &levelLoads,bool keepMinLevel,std::vector<double> &maxRejectedImport);
...
public:
    ...
    void evalNodeImportance(ImportantNode node,const std::vector<double> &minImportance,ImportantNodeSet &importSet,std::vector<double> &maxRejectedImport);
