...
- (bool)startLayer:(WhirlyKitLayerThread *)inLayerThread scene:(WhirlyKit::Scene *)inScene renderer:(SceneRendererES_iOS *)renderer viewC:(MaplyBaseViewController *)inViewC
{
