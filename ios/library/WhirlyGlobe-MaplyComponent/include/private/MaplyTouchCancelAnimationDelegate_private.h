/*  MaplyTouchCancelAnimationDelegate_private.h
 *  WhirlyGlobeLib
 *
...
@interface MaplyTouchCancelAnimationDelegate ()

@property (nonatomic) Maply::MapView_iOS *mapView;

/// Create a touch gesture and a delegate and wire them up to the given UIView
+ (MaplyTouchCancelAnimationDelegate*)touchDelegateForView:(UIView *)view
                                                   mapView:(Maply::MapView_iOS *)mapView;
