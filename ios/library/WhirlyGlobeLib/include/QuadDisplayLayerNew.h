...
- (double)importanceForTile:(WhirlyKit::QuadTreeIdentifier)ident mbr:(WhirlyKit::Mbr)mbr viewInfo:(WhirlyKit::ViewStateRef) viewState frameSize:(WhirlyKit::Point2f)frameSize attrs:(NSMutableDictionary * __nullable)attrs;
...
- (void)newViewState:(WhirlyKit::ViewStateRef)viewState;

/// Return true if the tile is visible, false otherwise
- (bool)visibilityForTile:(WhirlyKit::QuadTreeIdentifier)ident mbr:(WhirlyKit::Mbr)mbr viewInfo:(WhirlyKit::ViewStateRef) viewState frameSize:(WhirlyKit::Point2f)frameSize attrs:(NSMutableDictionary * __nullable)attrs;
...
@property (nonatomic,nullable) WhirlyKit::SceneRendererES2 *renderer;
...
- (nonnull)initWithDataSource:(NSObject<WhirlyKitQuadDataStructure> * __nonnull)dataStructure loader:(NSObject<WhirlyKitQuadLoaderNew> * __nonnull)loader renderer:(WhirlyKit::SceneRendererES * __nonnull)renderer;
