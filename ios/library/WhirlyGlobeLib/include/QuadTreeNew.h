...
public:
    ...
    bool evalNodeVisible(ImportantNode node,double minImport,double minImportTop,int maxNodes,const std::set<int> &levelsToLoad,int maxLevel,ImportantNodeSet &visibleSet);
