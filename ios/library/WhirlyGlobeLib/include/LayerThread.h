...
@property (nonatomic,weak) SceneRendererES *renderer;
...
- (id)initWithScene:(WhirlyKit::Scene *)inScene view:(View *)inView renderer:(SceneRendererES *)renderer mainLayerThread:(bool)mainLayerThread;
