...
public:
    ...
    virtual std::vector<DrawableString *> generateDrawableStrings(PlatformThreadInfo *threadInfo,const LabelInfo *,const FontTextureManagerRef &fontTexManager,float &lineHeight,ChangeSet &changes) override;
