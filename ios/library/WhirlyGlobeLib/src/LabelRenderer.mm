...
- (void)renderWithImages
{
    ...
    for (WhirlyKitSingleLabel *label in _strs)
    {
        ...
        if (_labelInfo.screenObject)
        {
            ...
            [label calcScreenExtents2:width2 height2:height2 iconSize:iconSize justify:_labelInfo.labelJustify corners:pts iconCorners:iconPts useIconOffset:(layoutEngine == false)];
            ...
            [label calcExtents2:width2 height2:height2 iconSize:iconSize justify:_labelInfo.labelJustify corners:pts norm:&norm iconCorners:iconPts coordAdapter:_coordAdapter];
